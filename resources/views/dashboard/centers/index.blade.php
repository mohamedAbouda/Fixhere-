...
<div class="row">
    ...
    <div class="col-md-4 col-md-offset-1 text-right col-xs-11">
        <a href="{{ route('dashboard.centers.create') }}"class="btn btn-blue margin-left-10">
            <span>+ </span>Add center
        </a>
    </div>
</div>
@stop
            ...
            <div class="col-md-5 margin-bottom10 margin-top20">
                <div class="total-customer-col pad5 pad-bottom5 col-md-12">
                    <div class="col-md-9 customer-stat-col-pad">
                        <h5 class="customer-stat-text pad5">Total centers count</h5>
                    </div>
            ...
            <table class="table table-borderless table-responsive" style="margin-bottom:0;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ $resource->cover_image_url }}" target="_blank">
                                <img src="{{ $resource->cover_image_url }}" alt="No cover pic" class="thumbnail" style="width:300px;height:250px;">
                            </a>
                        </td>
                        <td>
                            <h3 class="contact-list-view-column-categ margin-top10 contact-details-view" style="font-weight: 400;">
                                <a href="{{ route('dashboard.centers.show', $resource->id) }}">
                                    {{ $resource->name }}
                                </a>
                            </h3>
                        </td>
                        ...
                        <td>
                            <div class="no-shadow btn-group pull-right" style="margin:0;padding:0;">
                                ...
                                <ul class="dropdown-menu contact-dropdown pull-right">
                                    <li>
                                        <a href="{{ route('dashboard.centers.edit', $resource->id) }}">Edit</a>
                                    </li>
                                    <li>
                                        {{ Form::open(['route' => ['dashboard.centers.destroy' ,$resource->id] ,'method' => 'DELETE']) }}

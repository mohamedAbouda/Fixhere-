...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="form-group margin-bottom20 col-md-6">
            ...
            {{ Form::text('location',$resource->location,['id'=>'address','class' => 'form-control']) }}
        ...
        <div class="form-group margin-bottom20 col-md-6">
            ...
            {{ Form::text('contact_number',$resource->contact_number,['id'=>'contact_number','class' => 'form-control']) }}
            <p class="text-danger" style="margin-bottom: 0;">{{ $errors->first('contact_number') }}</p>
        </div>
        <div class="col-md-12">
            <div class="form-group">
                <div id="map" data-lat="{{ $resource->lat ? $resource->lat : '30.1197986' }}" data-lng="{{ $resource->lng ? $resource->lng : '31.5370003' }}">
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <input type="text" readonly class="form-control" name="lat" id="lat" style="color:#1f2626" value="{{ $resource->lat ? $resource->lat : '' }}">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <input type="text" readonly class="form-control" name="lng" id="lng" style="color:#1f2626" value="{{ $resource->lng ? $resource->lng : '' }}">
            </div>
        </div>
    </div>
</div>

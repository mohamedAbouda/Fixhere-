...
@section('content')
{{ Form::open(['route' => 'dashboard.orders.store','files'=>'true']) }}
<div class="row">
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="form-group margin-bottom20 col-md-6">
            ...
            {{ Form::text('service_type',old('service_type'),['id'=>'service_type','required'=>'required','class' => 'form-control']) }}
        ...
        <div class="form-group margin-bottom20 col-md-6">
            ...
            {{ Form::text('order_date',old('order_date'),['id'=>'order_date','required'=>'required','class' => 'form-control' ,'placeholder' => 'YYYY-MM-DD']) }}
        ...
        <div class="form-group margin-bottom20 col-md-6">
            ...
            {{ Form::text('time_from',old('time_from'),['id'=>'time_from','required'=>'required','class' => 'form-control','placeholder' => 'HH:mm']) }}
        ...
        <div class="form-group margin-bottom20 col-md-6">
            ...
            {{ Form::text('time_to',old('time_to'),['id'=>'time_to','required'=>'required','class' => 'form-control','placeholder' => 'HH:mm']) }}
    ...
    <div class="col-md-12">
        <div class="form-group margin-bottom20 col-md-12">
            ...
            {{ Form::select('client_id',$clients,old('client_id'),['id'=>'client_id','required'=>'required','class' => 'form-control','placeholder'=>'Select client']) }}
        ...
        <div class="form-group margin-bottom20 col-md-12">
            ...
            {{ Form::select('center_id',$centers,old('center_id'),['id'=>'center_id','required'=>'required','class' => 'form-control','placeholder'=>'Select center']) }}
        ...
        <div class="form-group margin-bottom20 col-md-12">
            ...
            <select class="form-control" name="agent_id" id="agent_id">
                ...
                <option value="{{ $agent->id }}" style="display:none;" data-parent-id="{{ $agent->parent_id }}">{{ $agent->name }}</option>
                @endforeach
            </select>
    ...
    <div class="col-md-12">
        <div class="form-group margin-bottom20 col-md-12">
            ...
            {{ Form::textarea('problem',old('problem'),['id'=>'problem','required'=>'required','class' => 'form-control']) }}

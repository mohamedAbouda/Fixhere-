...
<div class="row">
    <div class="col-md-4 col-sm-12">
        <h3 class="section-title">Add model</h3>
    </div>
</div>
@stop

@section('content')
{{ Form::open(['route' => 'dashboard.models.store', 'files'=>'true']) }}
<div class="row">
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        ...
        <div class="form-group margin-bottom20 col-md-12">
            ...
            {{ Form::select('brand_id', $brands, old('brand_id'), ['id'=>'brand_id', 'required'=>'required', 'class' => 'form-control']) }}

...
<div class="row">
    <div class="col-md-4 col-sm-12">
        <h3 class="section-title">Add faq</h3>
    </div>
</div>
@stop

@section('content')
{{ Form::open(['route' => 'dashboard.faqs.store','files'=>'true']) }}
<div class="row">
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="form-group margin-bottom20 col-md-12">
            ...
            {{ Form::text('question',old('question'),['id'=>'question','required'=>'required','class' => 'form-control']) }}
        ...
        <div class="form-group margin-bottom20 col-md-12">
            ...
            {{ Form::textarea('answer',old('answer'),['id'=>'answer','required'=>'required','class' => 'form-control']) }}
